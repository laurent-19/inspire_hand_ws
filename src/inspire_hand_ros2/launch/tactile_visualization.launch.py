...
Launches all nodes needed for the full pipeline without duplicates:
- Robot state publisher (TF and robot model)
- Tactile pointcloud node (generates colored 3D point cloud)
- Cylinder projection node (projects onto cylinder surface)
- Cylinder unwrap node (unwraps to 2D image)
- RViz (visualization)
"""
